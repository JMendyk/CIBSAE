...
\documentclass[english,lic,shortabstract]{iithesis}
...
\englishtitle   {Categorisation and implementation\fmlinebreak of build systems using\fmlinebreak algebraic effects}
...
\polishabstract{\textbf{Note to the reader}: This text is a rough, work-in-progress translation of the paper that was originally written in Polish. Thus, it will inevitably include many mistakes until I have time to fix them all. In the meantime, I hope you will enjoy reading it despite these slight difficulties.}
...
\date          {Wrocław 2020} % 4 września 2020}                     % Data zlozenia pracy
...
\input{2-effects_in_theory}

\input{3-build_systems_a_la_carte}

\input{4-effects_in_practise}

\input{5-build_systems_using_effects}
