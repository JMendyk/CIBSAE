...
\lstdefinestyle{helium}{
  ...
  literate={->}{$\rightarrow{}$}{1}
           {=>}{$\Rightarrow{}$}{1}
           %% {++}{+\kern-1.3ex+\kern0.8ex}{1}
           {==}{$={}$}{1},
  morekeywords={signature,handle,handler,resume,return,finally}
}
...
\lstinputlisting[style=helium]{code_examples/syntax.he}
...
\lstinputlisting[style=helium]{code_examples/error1__signature.he}

Stwórzmy funkcję podobną do \textit{question}, z tym że nie będzie ona lubić wartości ujemnych:

\lstinputlisting[style=helium, firstline=7, lastline=18]{code_examples/error2__inline_abort.he}
...
%% \begin{lstlisting}
%% let abortOnError = handler
%%                    | error () => printStr ``Error occured!\n''
%%                    end
%% \end{lstlisting}

\lstinputlisting[style=helium, firstline=7, lastline=10]{code_examples/error3__reused_handler.he}
...
\lstinputlisting[style=helium, firstline=12, lastline=13]{code_examples/error3__reused_handler.he}
...
%% \begin{lstlisting}
%% let warnOnError = handler
%%                   | error () => printStr ``Error occured, continuing...\n''; resume ()
%%                   end
%% \end{lstlisting}

\lstinputlisting[style=helium, firstline=7, lastline=10]{code_examples/error4__warn_not_abort.he}
...
\lstinputlisting[style=helium, lastline=22]{code_examples/nondet1__simple.he}
...
\lstinputlisting[style=helium, firstline=5, lastline=16]{code_examples/nondet2__count_sats.he}
...
%%   | amb () / r => r True + r False
%%   | return x => if x then 1 else 0
%%   | finally res => printStr (stringOfInt ret ++ " satisfying interpretations\n")
%%   end
...
\lstinputlisting[style=helium, firstline=5, lastline=17]{code_examples/nondet3__count_and_write_sats.he}
...
\lstinputlisting[style=helium, lastline=3]{code_examples/state1__basics.he}
...
\lstinputlisting[style=helium, firstline=5, lastline=11]{code_examples/state1__basics.he}
...
\lstinputlisting[style=helium, firstline=5, lastline=11]{code_examples/state2__run_state.he}

Dzięki zdefiniowanemu efektowi ubocznemu, operacjom oraz uchwytom możemy teraz łatwo wykonywać obliczenia ze stanem:

\lstinputlisting[style=helium, firstline=7, lastline=24]{code_examples/state3__example.he}
...
\lstinputlisting[style=helium, firstline=2, lastline=5]{code_examples/rec1__rec.he}

Co ciekawe, dzięki własnym efektom i operacjom możemy tworzyć funkcje rekurencyjne, które nie używają jawnie rekursji:

\lstinputlisting[style=helium, firstline=2, lastline=13]{code_examples/rec2__effect.he}
...
\lstinputlisting[style=helium, firstline=5, lastline=23]{code_examples/rec3__mutual.he}
...
\lstinputlisting[style=helium, firstline=1, lastline=5]{code_examples/fail_and_amb.he}

oraz bardzo proste uchwyty dla tych efektów:

\lstinputlisting[style=helium, firstline=7, lastline=15]{code_examples/fail_and_amb.he}

Definiujemy teraz funkcję sprawdzającą czy otrzymana formuła z trzema zmiennymi wolnymi jest spełnialna:

\lstinputlisting[style=helium, firstline=19, lastline=25]{code_examples/fail_and_amb.he}
...
\lstinputlisting[style=helium, firstline=27, lastline=33]{code_examples/fail_and_amb.he}
...
\lstinputlisting[style=helium, firstline=35, lastline=46]{code_examples/fail_and_amb.he}
